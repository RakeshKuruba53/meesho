...
public class AuthServiceImpl implements AuthService{
	...
	@Override
	public ResponseEntity<ResponseStructure<SimpleStructure>> logout(String accessToken,String refreshToken,
			HttpServletResponse httpServletResponse) {
		
		if(accessToken==null&&refreshToken==null)
			throw new UserNotLoggedInException("please login ur not logged in previously",HttpStatus.NOT_FOUND,"");
		...
		return new ResponseEntity<ResponseStructure<SimpleStructure>>(HttpStatus.GONE);
	}
